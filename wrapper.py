...
def main():
    ...
    parser.add_argument("--silentmessage",
        action="store",
        dest="silentmessage",
        default=False,
    ...
    try:
        api = PyiCloudService(command_line.username.strip(),
    ...
    for dev in api.devices:
        if command_line.device_id == False or \
...
#                print "\n"
            ...
            if command_line.sound == True:
                if command_line.device_id != False:
                    dev.play_sound()
                else:
                    raise RuntimeError("\n\n\t\t%s %s\n\n" %
            ...
            if command_line.silentmessage != False:
                if command_line.device_id != False:
            ...
            #   Enable Lost mode
            if command_line.lostmode != False:
                if command_line.device_id != False:
                    dev.lost_device(number=command_line.lost_phone.strip(),
